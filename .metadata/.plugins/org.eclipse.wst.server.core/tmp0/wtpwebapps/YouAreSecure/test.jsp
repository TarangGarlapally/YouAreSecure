...
<button type="button" id="open-modal" class="btn btn-info btn-lg" style="visibility:hidden;">Open Modal</button>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-success mybtn" data-dismiss="modal" onclick = "closefunc()">I am Safe</button>
...
try {
    ...
    if(f==0){
    	...
    	if(mysession.getAttribute("nofvisits")==null){
    		...
    		$(document).ready(function(){  // Show the Modal on load
  			  $("#myModal2").modal("show");
...
<script>
    	...
    	if(x!='null')
           ...
           function func() {
        	   mkey = setTimeout("waitfunc()", 20000);
           }
           function waitfunc(){
        	   location.href = "sos.jsp";
